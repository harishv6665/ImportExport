angular.module('BookKeeper')
    .service("HeaderService", ["$filter", function ($filter) {
        ...
        self.headers = {
            ...
            "ACTIONS": {
                "header": "action", "type": function (cell) {
            ...
            "LOAD": {"header": "load", "type": ""},
            "NET WEIGHT (Kgs)": {"header": "netWeightInKgs", "type": ""},
            "NO OF LOADS": {"header": "noOfLoads", "type": ""},
            ...
            "DIESEL CONSUMED (ltrs)": {"header": "dieselConsumed", "type": ""},
            "DIESEL ADDED (ltrs)": {"header": "dieselAdded", "type": ""},
